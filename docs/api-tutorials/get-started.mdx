---
title: "Get Started"
description: "Get started with AIBlock API"
...
Before diving into the AIBlock API, ensure you have the necessary tools. Head to the [**AIBlock Postman Collection**](/docs/postman-collections) and download our latest Postman collection. This equips you with all the resources needed to seamlessly integrate AIBlock functionalities into your applications.
...
Utilize the Postman collections to make requests to various AIBlock API endpoints.
