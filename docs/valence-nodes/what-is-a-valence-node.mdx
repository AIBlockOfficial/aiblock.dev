...
Valence nodes are a layer 2 solution for massively improving the scaling, throughput and efficiency of the A-Block network. 
...
Valence nodes scale the A-Block network functionality is **plugins**. Plugins extend the functionality of your Valence node and give it new abilities 
...
The Valence node code is open source, so you're welcome to contribute with your own plugins, or use plugins built by other members of the A-Block community.