---
title: "Get Started"
description: "Get started setting up your ABlock wallet through the A-Block.js SDK"
...
## Installation
Integration wih ABlock can be done simply and easily through the <a href="https://github.com/ABlockOfficial/A-Block.js#a-blockjs">A-Block.js SDK</a>. 
...
## Create ABlock Wallet

Creating an instance of an ABlock wallet can be done in three main ways:
...
You can create a new instance of an ABlock wallet via the SDK's `initNew` method:
...
ABlock is a UTXO blockchain, so you can generate a new keypair, for example, by using the `getNewKeypair` method:
