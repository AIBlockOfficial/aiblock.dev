---
title: "Get Started"
description: "Get started setting up your AIBlock wallet through the AIBlock.js SDK"
...
## Installation
Integration wih AIBlock can be done simply and easily through the <a href="https://github.com/AIBlockOfficial/AIBlock.js#a-blockjs">AIBlock.js SDK</a>. 
To get started, we can install it to our JavaScript/TypeScript project with `npm`:

```sh
npm install @aiblock/a-blockjs
```

or alternatively with `yarn`:

```sh
yarn add @aiblock/a-blockjs
```
