...
In addition to enabling auditable trades of tokens for data assets, the 2WT also enables item-based payments. A item-based payment is one in which Alice wants to give Bob 100 ZNT as a charitable gift, but requires Bob to approve the gift before it gets processed into a block.
