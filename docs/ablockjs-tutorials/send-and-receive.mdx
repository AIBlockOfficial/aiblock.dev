...
description: "Sending and receiving payments through AIBlock.js is quick and simple"
...
After setting up a wallet, you can send and receive payments very easily through the AIBlock.js SDK. If you're developing 
...
That's it! AIBlock.js has been designed to make sending and receiving payments as quick and easy as possible. Next, we'll take a look at how to make atomic, 2-way payments.
